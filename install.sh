...
if ! $config_only; then
    ...
    required=(
        ...
        gnome-keyring grim gtk3 materia-gtk-theme gvfs gvfs-mtp hypridle hyprland hyprlock hyprpicker
        ...
        inter-font cava pipewire pipewire-alsa pipewire-pulse playerctl polkit power-profiles-daemon python python-dbus-next
