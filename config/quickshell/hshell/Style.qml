...
Singleton {
    readonly property var palette: ["#080808", "#202020", "#343434", "#ffffff", "#a0a0a0", "#ffffff"]
    ...
    readonly property color activeFill: "#f5f5f5"
    readonly property color activeText: "#111111"
