    ...
    Column {
        ...
        Item {
            ...
            Row {
                ...
                ShellText {
                    ...
                    color: root.activeNote && root.activeNote.pinned ? Style.yellow : Style.foreground
                ...
                ShellText {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    text: "󰆴"
                    color: root.confirmingDelete ? Style.red : Style.muted
                    font.family: Style.iconFontFamily
                    font.pixelSize: 15
                    Accessible.role: Accessible.Button
            ...
            Column {
                ...
                ListView {
                    ...
                    ShellText {
                        ...
                        color: NotesState.lastError ? Style.red : Style.mutedDark
                        font.pixelSize: 10
                    }
                    ...
                    delegate: FocusScope {
                        ...
                        Rectangle {
                            ...
                            color: noteRow.selected || noteRow.activeFocus || notePointer.containsMouse ? Style.primaryContainer : "transparent"
                        }
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    height: 14
                    radius: 3
                    color: blockRow.checked ? Style.primary : "transparent"
                    border.width: 1
                    border.color: blockRow.checked ? Style.primary : Style.mutedDark
                ...
                Text {
                    ...
                    color: blockRow.checked ? Style.mutedDark : (blockRow.content ? Style.foreground : Style.mutedDark)
                ...
                TextEdit {
                    ...
                    selectedTextColor: Style.foreground
                    font.family: Style.fontFamily
                    font.pixelSize: blockRow.kind === "h1" ? 20 : (blockRow.kind === "h2" ? 18 : (blockRow.kind === "h3" ? 15 : 12))
                    font.weight: /^h[1-3]$/.test(blockRow.kind) ? Font.Bold : Font.Normal
        ...
        Item {
            ...
            ShellText {
                ...
                color: NotesState.saveStatus === "Save failed" ? Style.red : Style.mutedDark
                font.pixelSize: 8
            }
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        anchors.fill: parent
                        radius: Style.radiusSmall
                        color: root.paletteIndex === paletteRow.index ? Style.primaryContainer : "transparent"
                    }
                    ...
                    Column {
                        ...
                        ShellText {
                            ...
                            color: paletteRow.modelData.pinned ? Style.yellow : Style.foreground
                            elide: Text.ElideRight
                            font.pixelSize: 10
                            font.weight: Font.DemiBold
                        }
