...
Column {
    ...
    onVisibleChanged: if (visible && (kind === "speed" || kind === "ip")) History.reload()
    spacing: 10
    ...
    Loader {
        ...
        sourceComponent: root.kind === "disks" ? disks : root.kind === "speed" ? speed : root.kind === "download" ? download : root.kind === "media" ? media : root.kind === "ip" ? ip : root.kind === "emoji" ? emoji : root.kind === "periodic" ? periodic : settings
    }
    Component {
        id: disks
        Column {
    ...
    Component {
        ...
        Column {
            ...
            Choice {
                id: operation
                width: parent.width
                model: ["metadata", "mp3", "silent", "rotate", "mirror", "resize", "trim", "png"]
            }
            Field {
                id: parameter
                width: parent.width
    ...
    Component {
        ...
        Column {
            ...
            Flow {
                ...
                spacing: 6
                Repeater {
                    model: Emoji.entries.filter(e => String(e[0] + e[1]).toLowerCase().includes(query.text.toLowerCase()))
                    delegate: PillButton {
                        required property var modelData
                        width: 54
                        text: modelData[0]
        ...
        Column {
            ...
            BodyText {
                ...
                text: ({
                        ...
                        appearance: "Wallpapers and hshell themes are kept together.",
            ...
            Repeater {
                model: ({
                        ...
                        appearance: [["Wallpaper and theme", "appearance"]],
