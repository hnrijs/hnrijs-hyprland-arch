...
FocusScope {
    ...
    Column {
        ...
        ListView {
            ...
            width: parent.width
            height: Math.max(1, Math.min(5, count)) * 46
            spacing: 2
            clip: true
            ...
            delegate: Rectangle {
                ...
                color: index === root.selectedIndex ? Style.primaryContainer : "transparent"
        ...
        Rectangle {
            ...
            Flickable {
                ...
                ShellText {
                    ...
                    wrapMode: Text.Wrap
                    color: Backend.clipboardContentsLoading ? Style.muted : Style.foreground
                    font.pixelSize: 12
                }
