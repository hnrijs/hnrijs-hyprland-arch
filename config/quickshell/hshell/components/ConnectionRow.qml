...
FocusScope {
    ...
    Rectangle {
        ...
        color: pointer.containsMouse || root.activeFocus ? Style.primaryContainer : Style.bg0
    ...
    Rectangle {
        ...
        height: 27
        radius: 9
        color: root.active ? Style.primary : Style.bg2
    ...
    ShellText {
        ...
        color: root.active ? Style.primary : Style.aqua
    ...
    FocusScope {
        ...
        Rectangle {
            anchors.fill: parent
            radius: Style.radiusSmall
            color: secondaryPointer.containsMouse || secondaryAction.activeFocus ? Style.bg2 : "transparent"
        }

        ShellText {
            anchors.centerIn: parent
            text: root.secondaryActionIcon
            color: secondaryPointer.containsMouse || secondaryAction.activeFocus ? Style.red : Style.mutedDark
            font.pixelSize: 10
        }
