...
bind("Return", "xdg-terminal-exec")
bind("space", shell("launcher"))
bind("X", "xdg-terminal-exec nvim")
...
bind("SHIFT + U", "xdg-terminal-exec " .. script("tools.sh") .. " terminal update")
bind("SHIFT + C", "xdg-terminal-exec " .. script("tools.sh") .. " terminal clean")
bind("SHIFT + E", script("screen-search.sh"))
bind("SHIFT + S", script("screenshot.sh") .. " region")
bind("SHIFT + X", script("screenshot.sh") .. " full")
bind("SHIFT + H", shell("color"))
